"""
ResNet50 Model for Face Classification
...
class ResNet50FaceClassifier:
    """ResNet50-based face classification model"""
    ...
    def build_model(self) -> Model:
        ...
        # Create model
        self.model = Model(inputs=base_model.input, outputs=outputs, name='ResNet50_FaceClassifier')
    ...
    def get_gradcam_layer(self) -> str:
        ...
        # Fallback to last conv block in ResNet50
        return 'conv5_block3_out'
    
    @staticmethod
    def load_from_config(config_path: str, num_classes: int) -> 'ResNet50FaceClassifier':
        """
        ...
        Returns:
            ResNet50FaceClassifier instance
        """
        with open(config_path, 'r') as f:
            config = yaml.safe_load(f)
        
        model_config = config['models']['resnet50']
        return ResNet50FaceClassifier(num_classes, model_config)
...
def create_resnet50_model(num_classes: int, 
    ...
    """
    Convenience function to create and compile ResNet50 model
    ...
    Returns:
        Compiled Keras model
    """
    classifier = ResNet50FaceClassifier(num_classes)
...
if __name__ == "__main__":
    # Example usage
    print("Creating ResNet50 Face Classifier...")
    
    # Create model
    classifier = ResNet50FaceClassifier(num_classes=100)
    model = classifier.build_model()
